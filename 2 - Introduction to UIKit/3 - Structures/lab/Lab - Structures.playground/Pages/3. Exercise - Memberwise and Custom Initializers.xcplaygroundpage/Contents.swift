...
var favoritebook = book(title: "Hello", author: "bye", pages: 2000, price: 150)
    print("My favorite book is \(favoritebook.title) by \(favoritebook.author). It has \(favoritebook.pages) pages and it costs \(favoritebook.price) dollars.")
/*:
 ...
 */
var myHeight = height(heightInInches: ((12*5)+10))
print(myHeight)
