 ...
 */
let name = user(name: "Wise one", age: 88, height: 92, weight: 300, activityLevel: 99)
print("The user's name is \(name.name). They are \(name.age) years old, \(name.height) inches tall, and \(name.weight) pounds. Their activity level is \(name.activityLevel).")
/*:
...
var a = distance(meters: 4)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
print(distance(feet: 6))
