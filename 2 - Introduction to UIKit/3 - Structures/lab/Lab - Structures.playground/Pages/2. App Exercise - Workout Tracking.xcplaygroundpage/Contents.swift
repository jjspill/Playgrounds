 ...
 */
var firstRun = runningWorkout(distance: 2.0, time: 10.0, elevation: 0.0)
print(firstRun)
/*:
...
print("I ran \(firstRun.distance) meters in \(firstRun.time) minutes climbing an elevation of \(firstRun.elevation) meters.")
